package com.goodsProject.global.aop;

import com.goodsProject.global.api.ErrorDto;
...
public class BadRequestAspect {
    ...
    @Around("execution(* com.goodsProject.goods.*.controller..*.*(..))")
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String docs = Optional.ofNullable(env.getProperty("springdoc.swagger-ui.path")).orElse("/api/goods/");

        log.info("[bad request] validation check... requestUri=[{}] package = [{}], method = [{}]", requestURI, type, method);
