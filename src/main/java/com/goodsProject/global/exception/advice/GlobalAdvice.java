package com.goodsProject.global.exception.advice;
...
public class GlobalAdvice {
    ...
    private ProblemDetail createProblemDetail(HttpStatus httpStatus, String detail, List<ErrorDto> errors) {
        ...
        problemDetail.setType(URI.create(Optional.ofNullable(env.getProperty("springdoc.swagger-ui.path")).orElse("/api/goods/")));
